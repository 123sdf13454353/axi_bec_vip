...
# Design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_13)
...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.axi_becvip2 \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../axi_becvip2.gen/sources_1/bd/axi_becvip2/ipshared/ec67/hdl" \
       +incdir+"../../../../axi_becvip2.gen/sources_1/bd/axi_becvip2/ipshared/ec67/hdl" \
       +incdir+"D:/vivado_setting/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
