...
#
# Generated by export_simulation on Fri Oct 18 17:41:54 +0700 2024
#
################################################################################
...
'-reset_run' switch to the './axi_becvip2.sh' script.

./axi_becvip2.sh -reset_run
...
./axi_becvip2.sh -noclean_files

For more information on the script, please type './axi_becvip2.sh -help'.
