...
#
# Generated by Vivado on Mon Oct 14 10:24:53 +0700 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_13 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_becvip2 xil_defaultlib.axi_becvip2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  axi_becvip2 -key {Behavioral:sim_1:Functional:axi_becvip2} -tclbatch cmd.tcl -protoinst "protoinst_files/axi_becvip2.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/vivado_setting/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_becvip2.wdb xsim.dir)
